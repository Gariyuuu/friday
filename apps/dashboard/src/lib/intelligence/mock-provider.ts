...
/**
 * DEMO DATA. Simulates the shape and latency of a real intelligence pipeline
 * so the dashboard can be built and demoed before any provider (news/market/
 * weather API) is configured. Never presented as live in the UI without the
 * `isMock: true` freshness flag being surfaced — see DataFreshness badge.
 */
...
const MOCK_MARKETS: MarketQuote[] = [
  {
    symbol: "SPX",
    label: "S&P 500",
    price: 6812.4,
